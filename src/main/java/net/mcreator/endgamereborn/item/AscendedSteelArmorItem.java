...
public abstract class AscendedSteelArmorItem extends ArmorItem {
	public AscendedSteelArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends AscendedSteelArmorItem {
	...
	public static class Chestplate extends AscendedSteelArmorItem {
	...
	public static class Leggings extends AscendedSteelArmorItem {
	...
	public static class Boots extends AscendedSteelArmorItem {
